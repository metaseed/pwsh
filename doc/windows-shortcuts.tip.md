...
| Key                    | Note                                                                           |
| ---------------------- | ------------------------------------------------------------------------------ |
| `Alt+Tab`              | to switch between open apps, `alt+tab` again to next, `alt+shift+tab` to previous, and using `alt+left,right,up,down` to select active app. `Delete` to close the selected app|
| `Ctrl+Alt+Tab`|show overlayer to switch between opened apps, not close after release these keys, `ctrl+w` or `delete` to close app, and `Esc` to |
| `Ctrl+Z/Y`             | Undo/Redo.                                                                     |
...
|`Win+Esc`|Zoon reset|
|`Win+.`|emoji Keyboard|
|`Win+Ctrl+O`|virtual keyboard, again to close it|
