...
Install-FromGithub 'Powershell/Powershell' 'win-x64.msi$' -versionType 'stable' -getLocalInfoScript {
  ...
  # -WindowStyle Hidden
  Start-Process powershell.exe  -ArgumentList "-Command", "Wait-Process -Id $($msi.Id) -ErrorAction SilentlyContinue; [Console]::Beep(800, 300); Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('PowerShell(ver: $ver_online) installation completed!', 'Install-Pwsh')"
