...
net use M: /delete /y
net use M: \\tsclient\M /Persistent:yes # have to share the M drive in the local resources when connect the the VM
net use M: \\slb-fncl5y2\M /Persistent:yes # have to share M disk
