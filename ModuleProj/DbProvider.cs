...
namespace Metaseed.PowerShell.Providers
{
   ...
   /// </summary>
   [CmdletProvider("Access", ProviderCapabilities.None)]
   public class AccessDBProvider : NavigationCmdletProvider, IContentCmdletProvider
   {
       ...
       #region Drive Manipulation
        ...
        protected override PSDriveInfo NewDrive(PSDriveInfo drive)
        {
            ...
            var connetionString = @"Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ=" + drive.Root;

            OdbcConnection conn = new OdbcConnection(connetionString);
            conn.Open();
