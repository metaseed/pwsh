@{
  ...
  FunctionsToExport = @('Add-PathEnv', 'Assert-Admin', 'Close-Explorer', 'Config-WindowsLibrary', 'Download-GithubRelease', 'Get-AppInstallation', 'Get-Appx', 'Get-FolderSizeInfo', 'Get-Fonts', 'Get-FTA', 'Get-GithubRelease', 'Get-LastDeletedItems', 'Get-LocalAppInfo', 'Get-OpenedExplorer', 'Get-PendingReboot', 'Get-ProcessFromPort', 'Get-PTA', 'Get-RecycledItem', 'Install-App', 'Install-Font', 'Install-FromGithub', 'Install-FromWeb', 'Invoke-Admin', 'New-AdminShell', 'New-PSDriveHere', 'New-ShortCut', 'Open-KnownFolder', 'open-recycleBin', 'Open-SystemSetting', 'Pin-TaskBar', 'Register-FTA', 'Remove-EmptyDirectory', 'Remove-EnvVarDuplicateValues', 'Remove-ItemSafely', 'Remove-PathEnv', 'Repair-AclCorruption', 'Restore-RecycledItem', 'Set-FTA', 'Set-KnownFolderPath', 'Set-ModifyPermission', 'Set-ShortcutElevation', 'Set-StartTask', 'Show-RecycleBinSize', 'Sleep-Computer', 'Start-Explorer', 'sudo', 'Test-Admin', 'Test-AppInstallation', 'Test-ProcessElevated', 'Uninstall-Apps', 'Uninstall-Appx', 'Uninstall-Font', 'Update-ProcessEnvVar', 'Update-ProcessEnvVarPath', 'Watch-Table')
